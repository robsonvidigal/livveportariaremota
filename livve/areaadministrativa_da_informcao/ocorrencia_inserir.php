...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_horario")) {
  ...
  $insertGoTo = "ocorrencia_inserir.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_provider, $provider);
$query_in_ocorrencias = "SELECT * FROM informacao ORDER BY id DESC";
...
<div id="header">
  <div id="logo">
    <h1><a href="#"><span>BOLETIM</span>OPERACIONAL - call<span class="style19">center</span> - <span class="style19">inserir</span>ocorr&ecirc;ncia </a></h1>
  </div>
  <div id="menu">
    <ul id="main">
...
?>              
          ...
          <tr valign="baseline">
            ...
            <td align="center" valign="middle"><span class="style54">Unidade</span></td>
          ...
          <tr valign="baseline">
            <td align="center" valign="middle" nowrap="nowrap"><span class="style54" id="assunto">T&iacute;tulo</span></td>
  ...
  <table width="616" height="40" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#7C0104">
    <tr>
      <td height="25" align="center" class="texto11"><iframe src="nadigital.php?pesquisar=em+andamento&amp;Submit=PESQUISAR" name="fonline" width="600" marginwidth="0" height="23" marginheight="0" scrolling="Auto" frameborder="0" id="fonline"> </iframe></td>
    </tr>
  </table>
  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
          ...
          <td height="32" align="center" valign="middle"><table width="500" height="47" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td align="center" valign="middle"><table width="154" border="0" cellpadding="0" cellspacing="0" bordercolor="">
                    <tr>
                      <td width="39" align="center" valign="middle"><a href="<?php printf("%s?pageNum_in_ocorrencias=%d%s", $currentPage, 0, $queryString_in_ocorrencias); ?>"><img src="../imagens/primeira.gif" width="20" height="20" border="0" /></a></td>
                      <td width="36" align="center" valign="middle"><a href="<?php printf("%s?pageNum_in_ocorrencias=%d%s", $currentPage, max(0, $pageNum_in_ocorrencias - 1), $queryString_in_ocorrencias); ?>"><img src="../imagens/anterior.gif" width="20" height="20" border="0" /></a></td>
                      <td width="40" align="center" valign="middle"><a href="<?php printf("%s?pageNum_in_ocorrencias=%d%s", $currentPage, min($totalPages_in_ocorrencias, $pageNum_in_ocorrencias + 1), $queryString_in_ocorrencias); ?>"><img src="../imagens/proxima.gif" width="20" height="20" border="0" /></a></td>
                      <td width="39" align="center" valign="middle"><a href="<?php printf("%s?pageNum_in_ocorrencias=%d%s", $currentPage, $totalPages_in_ocorrencias, $queryString_in_ocorrencias); ?>"><img src="../imagens/avanca.gif" width="20" height="20" border="0" /></a></td>
                    </tr>
                </table></td>
              </tr>
          </table></td>
              ...
              <tr>
                <td width="772" height="127" align="left" valign="middle"><?php do { ?>
                    <table width="112" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="56" height="33" align="center" valign="middle"><a href="ocorrencia_editar.php?id=<?php echo $row_in_ocorrencias['id']; ?>"><img src="../images/edit.ico" width="34" height="27" border="0" /></a></td>
                        <td width="56" align="center" valign="middle"><a href="ocorrencia_excluir.php?id=<?php echo $row_in_ocorrencias['id']; ?>"><img src="../images/delete.ico" width="34" height="27" border="0" /></a></td>
                      </tr>
                    </table>
                  <table width="804" height="79" border="0" align="center">
                      <tr>
                        <td height="75"><div align="justify"><span class="style10"><span class="style19"><strong><?php echo $row_in_ocorrencias['horario']; ?></strong></span> - <span class="style19"><?php echo $row_in_ocorrencias['operador']; ?></span> <span class="style19"><?php echo $row_in_ocorrencias['rd']; ?> - </span> <span class="style57">
                                <?php  echo strip_tags($row_in_ocorrencias['assunto'], "<href><i>"); ?>
                                  </span><span class="style19"><br /><?php echo strip_tags ( nl2br ($row_in_ocorrencias['informacao']), "<strong><em><span><img><li><p><ol><ul><a>"); ?></span><br />
                            <span class="style20"><?php echo $row_in_ocorrencias['dia']; ?>, Controlador(a): <?php echo $row_in_ocorrencias['controlador']; ?></span></span></div>
                            <p>&nbsp;</p></td>
                      </tr>
                    </table>
                  <?php } while ($row_in_ocorrencias = mysql_fetch_assoc($in_ocorrencias)); ?></td>
              </tr>
          </table></td>
        </tr>
        <tr>
...
<?php
mysql_free_result($in_ocorrencias);
?>
