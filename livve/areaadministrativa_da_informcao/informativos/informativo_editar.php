  ...
  <div id="page">
    ...
    <form action="<?php echo $editFormAction; ?>  " method="post" id="form1"" onSubmit="return validaCampoObrigatorio(this)"">
      <table width="675" height="279" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr valign="baseline">
          <td height="26" align="center" valign="middle" nowrap="nowrap"><span class="style11" id="rd">Distrito:</span></td>
...
?>
              <option value="COD ARAPIRACA">COD ARAPIRACA</option>
              <option value="COD PENEDO">COD PENEDO</option>
              <option value="COD PALMEIRA">COD PALMEIRA</option>
              <option value="COD SANTANA">COD SANTANA</option>
              <option value="COD DELMIRO">COD DELMIRO</option>
              <option value="COD S&Atilde;O MIGUEL">COD S&Atilde;O MIGUEL</option>
              <option value="COD RIO LARGO">COD RIO LARGO</option>
              <option value="COD UNI&Atilde;O">COD UNI&Atilde;O</option>
              <option value="COD MATRIZ">COD MATRIZ</option>
              <option value="COI MACEI&Oacute;">COI MACEI&Oacute;</option>
              <option value="COS">COS</option>
              <option value="COORDENA&Ccedil;&Atilde;O">COORDENA&Ccedil;&Atilde;O</option>
              <option value="SUPERVIS&Atilde;O">SUPERVIS&Atilde;O</option>
              <option value="ELETROBRAS">ELETROBRAS</option>
              <option value="COMERCIAL DA CAPITAL">COMERCIAL DA CAPITAL</option>
              <option value="COMERCIAL DO INTERIOR">COMERCIAL DO INTERIOR</option>
          </select></td>
        </tr>
        <tr valign="baseline">
          <td align="center" valign="middle" nowrap="nowrap"><span class="style11" id="assunto">Ocorr&ecirc;ncia: </span></td>
