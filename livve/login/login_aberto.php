...
if (isset($_POST['login'])) {
  ...
  $MM_redirectLoginSuccess = "../areaadministrativa_da_informcao/ocorrencia_inserir.php";
...
<title>:: Login ::</title>
<meta http-equiv='Refresh' content='0;URL=../areaadministrativa_da_informcao/ocorrencia_inserir.php' />
  ...
  <div id="page">
    ...
    <form id="form1" method="post" action="<?php echo $loginFormAction; ?>">
      <table width="490" height="350" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <th height="28" align="center" valign="middle" background="../images/img02.jpg" scope="col"><span class="style50">Bem Vindo(a), Digite  Login e Senha</span></th>
        </tr>
        <tr>
          <th width="128" height="139" align="left" valign="middle" scope="col"><img src="../images/untitled.png" width="191" height="196" /></th>
        </tr>
        <tr>
          <th height="21" align="center" valign="top" scope="col"><span class="style49"> </span></th>
        </tr>
        <tr>
          <th height="88" align="center" valign="top" scope="col">&nbsp;</th>
        </tr>
      </table>
    </form>
    <!-- end content -->
