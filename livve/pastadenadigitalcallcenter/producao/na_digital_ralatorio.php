...
mysql_select_db($database_provider, $provider);
$query_con_sit = sprintf("SELECT * FROM tb_na WHERE tb_na.prioridade LIKE'%%%s%%' AND situacao = 'em andamento'  ORDER BY distrito ASC", $colname_con_sit);
...
<table width="720" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" bgcolor="#FFFFFF">
  <tr>
    <td class="style48"><div align="center" class="style57">Relat&oacute;rio de Servi&ccedil;os - Todos </div></td>
  </tr>
</table><br />
<table width="720" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" bgcolor="#FFFFFF">
  <tr>
