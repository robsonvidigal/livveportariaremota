...
tb_na.prioridade LIKE'%%%s%%' AND situacao = 'em andamento' ORDER BY distrito ASC", $colname_con_sit);
...
<title>NA emitida em <?php		$data_title = date ("d-m-Y");		$hora_title = date ("H:i:s");		echo"$data_title às $hora_title";				 ?></title>
<style type="text/css">
<!--
body {
        margin-left: 0px;
...
.style66 {font-family: Arial, Helvetica, sans-serif; font-size: 9; }
.style67 {font-size: 9}
...
<table width="720" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" bgcolor="#FFFFFF">
  <tr>
    <td class="style48"><div align="center" class="style57">Relat&oacute;rio de Servi&ccedil;o</div></td>
  </tr>
</table><br />
<table width="720" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" bgcolor="#FFFFFF">
  <tr>
    <td width="100" align="center" valign="middle"><a href="na_digital_ralatorio.php?prioridade=" class="style68">Inicio</a></td>
    <td width="100" align="center" valign="middle"><a href="na_digital_ralatorio_emergencial_fio_partido.php?prioridade=" class="style68">&Aacute;GUA 01 </a></td>
    <td width="100" align="center" valign="middle"><a href="na_digital_ralatorio_emergencial.php?prioridade=" class="style68">&Aacute;GUA 02 </a></td>
    <td width="100" align="center" valign="middle"><a href="na_digital_ralatorio_comercial.php?prioridade=" class="style68">&Aacute;GUA 03 </a></td>
    <td width="100" align="center" valign="middle"><a href="na_digital_ralatorio_comercial_agendamento_religacao.php?prioridade=" class="style68">&Aacute;GUA 04 </a></td>
  ...
  <td height="306" align="center" valign="middle"><?php do { ?>
    ...
    <table width="710" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        <tr>
          ...
          <td width="133" align="left" valign="baseline" class="style46">&nbsp;</td>
    ...
    <table width="710" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#CCCCCC">
        <tr>
          ...
          <td width="53" align="left" valign="top"><span class="style50">UNIDADE:</span></td>
